...
namespace MealToken.Infrastructure.Migrations
{
    ...
    [Migration("20251117054449_changeconsumptb")]
    partial class changeconsumptb
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MealToken.Domain.Entities.ManualTokenPrinted", b =>
                {
                    b.Property<int>("ManualTokenPrintedId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ManualTokenPrintedId"));
                    ...
                    b.HasKey("ManualTokenPrintedId");

                    b.HasIndex("MealConsumptionId");

                    b.HasIndex("PersonId");

                    b.HasIndex("TenantId");

                    b.ToTable("ManualTokenPrinted", "dbo");
                });
            ...
            modelBuilder.Entity("MealToken.Domain.Entities.RequestMealConsumption", b =>
                {
                    b.Property<int>("RequestMealConsumptionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("RequestMealConsumptionId"));
                    ...
                    b.Property<decimal>("TotalCompanyContribution")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<decimal>("TotalSupplierCost")
                        .HasColumnType("decimal(18,2)");

                    b.HasKey("RequestMealConsumptionId");
                    ...
                    b.ToTable("RequestMealConsumption", "dbo");
                });
            ...
            modelBuilder.Entity("MealToken.Domain.Entities.ManualTokenPrinted", b =>
                {
                    b.HasOne("MealToken.Domain.Entities.MealConsumption", null)
                        .WithMany()
                        .HasForeignKey("MealConsumptionId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
